...
def test_sender_parameters(sender, text, client_name, messenger, telegram_id, send_telegram, expected_result):
...
def test_sender_positive_telegram_send_with_mock():
    ...
    with patch('src.abc_expl.sender.service.telegram.service_sender.TelegramSendMessageService.send_message') as mock_send:
